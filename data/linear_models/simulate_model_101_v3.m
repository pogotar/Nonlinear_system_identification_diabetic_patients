...
for main_folder = main_folders
    ...
    for sottocartella = sottocartelle
        if strcmp(sottocartella{1}, 'sc_30days_identification_rwgn') || strcmp(sottocartella{1}, 'sc_1_day_test_IR_meal_80g_13h') || strcmp(sottocartella{1}, 'sc_1_day_test_IR_insulin_30g_13h') || strcmp(sottocartella{1}, 'PAV_EXT_1_100')
            ...
            for k = dati_paziente
                ...
                if strcmp(sottocartella{1}, 'sc_1_day_test_IR_meal_80g_13h') || strcmp(sottocartella{1}, 'sc_1_day_test_IR_insulin_30g_13h')
