...
class ClosedLoopSystem_SSM(nn.Module):
    ...
    def run(self, u_ext, time, y0=None):
        ...
        self.y_prev = y # TODO  non propriamente corretto dato che è giustoinizializare il controllore ma non è giusto metterlo come prima predizione del modello dato che stati non sono aggiustati
