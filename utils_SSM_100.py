...
def set_params(root, exp_identifier=None, folder_model_101=None, epochs_s1 = 2000, epochs_s2 = 1000, epochs_101 = None, learning_rate = 1e-3, use_noise = False):
    # # # # # # # # Parameters # # # # # # # #
    ...
    return x0, input_dim, output_dim, dim_internal, dim_nl, y_init, IQC_type, gamma, learning_rate, epochs_s1, epochs_s2, epochs_101, data_path, model_folder, redo_save, ts, use_noise, num_days, redo_save_101_I, redo_save_101_M, exp_identifier, folder_model_101
